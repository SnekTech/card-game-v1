...
public partial class SceneFactoryInitializer : Node
{
    public override void _Ready()
    {
        ...
        SceneFactory.Register<BattleReward>("res://Scenes/UI/battle_reward/BattleReward.tscn");
        ...
        SceneFactory.Register<Campfire>("res://Scenes/UI/campfire/Campfire.tscn");
        SceneFactory.Register<Shop>("res://Scenes/UI/shop/Shop.tscn");
        SceneFactory.Register<TreasureRoom>("res://Scenes/UI/treasure_room/TreasureRoom.tscn");
